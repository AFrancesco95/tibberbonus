...
export default function EnglishHome() {
  return <div className="min-h-screen flex flex-col">
    ...
    <main>
      ...
      <section id="benefits" className="scroll-mt-20 bg-secondary/30 px-4 py-20 md:py-28"><div className="mx-auto max-w-6xl text-center"><h2 className="mb-4 text-3xl font-bold md:text-4xl">Why Tibber?</h2><p className="mx-auto mb-12 max-w-2xl text-lg text-muted-foreground">Smart tools and dynamic rates help you understand and manage your energy use.</p><FeatureCards locale="en" /></div></section>
    </main>
    <Footer locale="en" />
  </div>
}
